...
class S3StorageProvider {
  ...
  async save(file, folder) {
    ...
    const ContentType = _mime.default.getType(originalName); // gets the content type of the file with the original name
    ...
    await _fs.default.promises.unlink(originalName); // deletes the file from the tmp folder
