...
let ListCategoriesUseCase = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute() {
    // Como estou seguindo o Single Responsability Principle do SOLID, e está classe já tenha o seu propósito definido no nome, não tem o porque ter um méstodo com um nome se não o nome exectue. Manter este padrão.
